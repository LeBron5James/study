        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: showClassOne }" @click="changeOrder('1')">
                  <a
                    >综合
                    <span
                      v-show="showClassOne"
                ...
                <li :class="{ active: showClassTwo }" @click="changeOrder('2')">
                  <a
                    >价格
                    <span
                      v-show="showClassTwo"
...
export default {
  ...
  methods: {
    ...
    removeCategoryName() {
      //带给服务器的参数可有可无，当为undefined，字段不会带给服务器
